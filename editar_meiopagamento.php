...
<form action="_atualizar_meiopagamento.php" method="post" style="margin-top: 20px;">
        <?php

            $sql = "SELECT * FROM meiopagamento WHERE idMeioPagamento = $id";
        ...
        <form>
        <div class="mb-3">
        <label>Descrição do Meio de pagamento</label>
