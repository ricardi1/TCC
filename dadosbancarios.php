...
<html>
    ...
    <div class="container" style="margin-top: 90px; width: 800px;">
            ...
            <tbody>
                    <?php
                        ...
                        $sql =  "SELECT dadosbancarios.idDadosBancarios,
                                ...
                                FROM dadosbancarios
                                LEFT JOIN fornecedor ON fornecedor.idFornecedor = dadosbancarios.Fornecedor_idFornecedor ORDER BY banco";
                ...
                <tr>
                    ...
                    <td><a class="btn btn-warning btn-sm" href="editar_dadosbancarios.php?id=<?php echo $idDadosBancarios ?>" role="button" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-regular fa-pen-to-square"></i></a>

                        <a class="btn btn-danger btn-sm" href="deletar_dadosbancarios.php?id=<?php echo $idDadosBancarios ?>" role="button" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa-regular fa-trash-can"></i></a></td>
