...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="container" style="margin-top: 90px; width: 500px;">
        ...
        <form action="_inserir_orcamento.php" method="post" style="margin-top: 20px;">
            ...
            <input type="text" class="form-control" name="codigo" id="orcamento" placeholder="Insira o código do orçamento" required autocomplete="off">
            </div>
