        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-warning btn-sm" href="editar_orcamento.php?id=<?php echo $idOrcamento ?>" role="button" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-regular fa-pen-to-square"></i></a>

                        <a class="btn btn-danger btn-sm" href="deletar_orcamento.php?id=<?php echo $idOrcamento ?>" role="button" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa-regular fa-trash-can"></i></a></td>
