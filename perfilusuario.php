    ...
    <div class="container" style="margin-top: 90px; width: 500px;">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $nome ?></td>
                    <td><a class="btn btn-warning btn-sm" href="editar_perfilusuario.php?id=<?php echo $idPerfilUsuario ?>" role="button" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-regular fa-pen-to-square"></i></a>

                        <a class="btn btn-danger btn-sm" href="deletar_perfilusuario.php?id=<?php echo $idPerfilUsuario ?>" role="button" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa-regular fa-trash-can"></i></a></td>
