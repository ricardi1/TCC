...
<form action="_atualizar_ccustos.php" method="post" style="margin-top: 20px;">
        <?php
        ...
        <input type="text" class="form-control" name="codigo" id="ccusto" value="<?php echo $codigo ?>" disabled>
