...
<html>
    ...
    <div class="container" style="margin-top: 90px; width: 1300px;">
        <h3>Fornecedores</h3>
        <br>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-warning btn-sm" href="editar_fornecedor.php?id=<?php echo $idFornecedor ?>" role="button" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-regular fa-pen-to-square"></i></a>

                        <a class="btn btn-danger btn-sm" href="deletar_fornecedor.php?id=<?php echo $idFornecedor ?>" role="button" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa-regular fa-trash-can"></i></a></td>
