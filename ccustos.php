    ...
    <div class="container" style="margin-top: 90px; width: 500px;">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                    <?php
                        include 'conexao.php';
                        $sql = "    SELECT ccustos.idCCustos,
                                        ccustos.codigo,
                                        ccustos.descricao
                                FROM ccustos
                                ORDER BY ccustos.codigo";
                ...
                <tr>
                    ...
                    <td><a class="btn btn-warning btn-sm" href="editar_ccustos.php?id=<?php echo $idCCustos ?>" role="button" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-regular fa-pen-to-square"></i></a>

                        <a class="btn btn-danger btn-sm" href="deletar_ccustos.php?id=<?php echo $idCCustos ?>" role="button" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa-regular fa-trash-can"></i></a></td>
