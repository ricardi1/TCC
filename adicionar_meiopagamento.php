<!DOCTYPE html>
<head>
    <title>Inserir Meio de Pagamento</title>
...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="container" style="margin-top: 90px; width: 500px;">
        ...
        <form action="_inserir_meiopagamento.php" method="post" style="margin-top: 20px;">
            ...
            <div class="mb-3">
            <label>Descrição Meio de Pagamento</label>
            <input type="text" class="form-control" name="descricao" placeholder="Insira o nome do meio de pagamento" required autocomplete="off">
            </div>
